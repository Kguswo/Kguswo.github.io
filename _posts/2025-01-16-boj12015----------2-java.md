...
description: "문제 링크 메모리: 100136 KB, 시간: 496 ms이분 탐색, 가장 긴 증가하는 부분 수열: O(n log n)2025년 1월 16일 02:50:23LIS알고리즘을 이분탐색을 적용해보았다. N이 클때 O(NlogN)으로 완료해야한다.어떻게 배열을 구상해야할지 참"
