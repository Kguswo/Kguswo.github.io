...
description: "문제 링크 메모리: undefined, 시간: 코딩테스트 연습 > SELECT합계: 100.0 / 100.02025년 07월 02일 03:41:06출처: 프로그래머스 코딩 테스트 연습, https&#x3A;//school.programmers.co.kr/learn/ch"
date: 2025-07-01T18:41:01.861Z
tags: ["sql","프로그래머스"]
slug: "PGMS특정-물고기를-잡은-총-수-구하기-SQL"
thumbnail: "/assets/posts/0a5faea76d14f8466dd7c7673146537d068763d758e0e9bda80220ef90b294b8.png"
categories: SQL
toc: true
velogSync:
  lastSyncedAt: 2025-08-26T02:00:50.751Z
  hash: "6187fe6aa8f050d2f53312bf16d0a2be2c98a777d4b3892c36dc193e057b2219"
---

# [level 2] 특정 물고기를 잡은 총 수 구하기 - 298518 Add commentMore actions
...
서브쿼리로 해당 FISH_TYPE을 찾고 IN으로 조건검색하였다
![](/assets/posts/0a5faea76d14f8466dd7c7673146537d068763d758e0e9bda80220ef90b294b8.png)
...
SELECT COUNT(*) AS FISH_COUNT
    FROM FISH_INFO
        WHERE FISH_TYPE IN(
            SELECT FISH_TYPE
                FROM FISH_NAME_INFO
                    WHERE FISH_NAME LIKE 'SNAPPER' OR FISH_NAME LIKE 'BASS')
